...
class CanUse:
    def __init__(self, zone):
        self.bus_ins = can.interface.Bus(channel='vcan0', bustype='socketcan')
        self.bus_vcu = can.interface.Bus(channel='vcan1', bustype='socketcan')
        ...
        self.ego_yaw = self.previous_yaw
